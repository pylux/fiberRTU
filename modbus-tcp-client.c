...
int main(int argc, char *argv[])
{
    ...
    int nb_points;
    float elapsed;
    int16_t wirte_data[10] = {3,1,2,4,5,6,8,7,9,10};
    ...
    tab_reg = (uint16_t *) malloc(MODBUS_MAX_WR_WRITE_REGISTERS * sizeof(uint16_t));
    memset(tab_reg, 0, MODBUS_MAX_WR_WRITE_REGISTERS * sizeof(uint16_t));
